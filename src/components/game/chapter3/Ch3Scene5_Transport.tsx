        ...
        {phase === 'intro' && (
          <div className="space-y-4">
            <DialogBox character="marcus">
              <p>"Le DNS fonctionne. Mais le site reste inaccessible. Ici, on parle <span className="text-primary font-bold">transport</span>.
              Couche 4 — TCP/UDP. Si le port est fermé, le service n'écoute pas."</p>
            </DialogBox>
